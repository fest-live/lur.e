import { observeAttributeBySelector, handleAttribute, containsOrSelf, MOCElement, observeBySelector, observeAttribute } from "@fest-lib/dom";
import { getAdoptedStyleRule } from "@fest-lib/style-lib";
